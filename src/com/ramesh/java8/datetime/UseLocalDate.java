...
class UseLocalDate {
	...
	public static void main(String[] args) {
		...
		System.out.println(localDate.getLocalDateUsingFactoryOfMethod(2016, 5, 10).toString());
		System.out.println(localDate.getLocalDateUsingParseMethod("2016-05-10").toString());
